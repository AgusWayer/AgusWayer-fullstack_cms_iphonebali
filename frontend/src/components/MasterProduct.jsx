...
const MasterProduct = ({ result }) => {
  ...
  return (
    <div className="p-5 w-full px-9 relative overflow-x-scroll md:overflow-x-hidden">
      ...
      <div>
        <h1 className="font-semibold text-3xl text-[#180E4F]">Master Products</h1>
        <div className="flex border items-center rounded-md border-gray-500 w-fit px-2 py-1 mt-3">
          <AiOutlineSearch className="text-xl" />
          <input type="text" className="rounded-md bg-transparent focus:outline-none" placeholder="Search Products..." />
        </div>
        <select className="border-black border-[1px] px-3 py-1 rounded-md mt-6 bg-transparent">
          <option value="" selected hidden>
            Sort By
          </option>
          <option value="">Nama Product</option>
        ...
        <table className="table-auto  mx-auto w-full text-center border-spacing-2  border-collapse" cellPadding={"12"}>
          ...
          <tbody className="divide-y-8 divide-[#E8E8E8]">
            <tr className="bg-white bg rounded-lg shadow-lg ">
              <td className="">1</td>
              <td>Macbook</td>
              <td className="">Mekbook</td>
              <td className="">Img</td>
              <td className="">5</td>
              <td className="">Rp.500.000</td>
              <td>New</td>
              <td className="">
